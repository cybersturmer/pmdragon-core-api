...
FILE_EXTENSIONS_MAPPING = (
    ...
    ((TEXT_PLAIN,), ['py'], ICON_CHOICES[7], False),
    (('text/javascript',
      'application/javascript'),
     ['js', 'vue'], ICON_CHOICES[8], False),
    (('text/html',), ['html'], ICON_CHOICES[9], False),
    (('application/javascript',), ['ts'], ICON_CHOICES[10], False),
    (('text/x-c', TEXT_PLAIN), ['cpp', 'h'], ICON_CHOICES[11], False),
    ((TEXT_PLAIN,), ['cs'], ICON_CHOICES[13], False),
    ((TEXT_PLAIN,), ['go'], ICON_CHOICES[14], False),
    ((TEXT_PLAIN, TEXT_PLAIN, TEXT_PLAIN),
     ['kt', 'kts', 'ktm'], ICON_CHOICES[15], False),
    ((TEXT_PLAIN,), ['lua'], ICON_CHOICES[16], False),
    (('text/x-fortran',
      'text/x-fortran'), ['f95', 'f03'], ICON_CHOICES[17], False),
    ((TEXT_PLAIN,
      TEXT_PLAIN), ['hs', 'hls'], ICON_CHOICES[18], False),
    (('text/markdown',
      'text/markdown'), ['markdown', 'md'], ICON_CHOICES[19], False),
    (('text/html',), ['php'], ICON_CHOICES[20], False),
    ((TEXT_PLAIN,), ['r', 'rdata', 'rds', 'rda'], ICON_CHOICES[21], False),
    ((TEXT_PLAIN,), ['rb'], ICON_CHOICES[22], False),
    ((TEXT_PLAIN,
      TEXT_PLAIN), ['rs', 'rlib'], ICON_CHOICES[23], False),
    ((TEXT_PLAIN,), ['swift'], ICON_CHOICES[24], False),
    ((TEXT_PLAIN,), ['xaml'], ICON_CHOICES[25], False),
    ((TEXT_PLAIN,
